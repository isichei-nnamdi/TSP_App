...
# from models import Feedback, FtaAssignments  # Assuming these are defined
...
#     assigned_ftas = session.query(FtaAssignments.fta_id).filter_by(assigned_to=email).all()
